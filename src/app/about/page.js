      ...
      <div className="max-w-7xl mx-auto px-4 pb-20">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-8 md:p-12 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed text-lg md:text-xl">
            <p className="mb-6">
              جمعية تنموية شبابية غير ربحية، تأسست في الأردن في عام 2012، لتشارك بفعالية في الجهود الوطنية تجاه تمكين الشباب الأردني وتعزيز دوره في تنمية المجتمع بكافة مكوناته من أطفال ونساء وأسر. نحن شغوفون بتمكين الشباب وبناء مجتمع أكثر وعياً وقدرة. نؤمن بأن الشباب هم قوة التغيير، وأن المجتمع المزدهر لا يكتمل بدون طاقة أفراده، من أطفال ونساء وأسر. رؤيتنا واضحة: <strong className="text-[#94C83D]">شباب ريادي. مجتمع ممكن.</strong>
            </p>
            <p className="mb-6">
