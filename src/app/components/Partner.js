...
const Partners = () =>{
  ...
  return (
    <div style={{ backgroundColor: '#F9F9F9' }}className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-700">
            أكثر من <span className="font-bold text-gray-900">34 شريك</span> يساهمون في تحقيق رؤيتنا
          </p>
        </div>
